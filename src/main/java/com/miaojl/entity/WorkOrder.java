...
public class WorkOrder {
     ...
     * tu.name transfer_user_name,tu.phone transfer_user_phone,`to`.name transfer_office_name,
    ...
    public String getTransferOfficeName() {
        return transferOfficeName;
    }

    public void setTransferOfficeName(String transferOfficeName) {
